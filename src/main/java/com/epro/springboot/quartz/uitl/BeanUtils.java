...
public class BeanUtils
{
     ...
     * @param dest 目标对象
     * @param src 源对象
     * @param ignoreNullProp 如果源属性为 null, 则不覆盖 目标属性
     */
    public static void copyBeanProp(Object dest, Object src, boolean ignoreNullProp)
    {
